...
const LEAF_GATE: LocationConfig = {
  ...
  terrainEffects: [],
  biome: 'Village Gate',
  enemyPool: ['missing_nin', 'forest_bandit', 'desperate_traveler', 'hired_muscle', 'ronin', 'village_thug'],
...
const RIVER_ROAD: LocationConfig = {
  ...
  biome: 'River Banks',
  enemyPool: ['river_bandit', 'missing_nin', 'ronin', 'camp_raider', 'stranded_ronin', 'hired_assassin'],
...
const SOUND_BORDER: LocationConfig = {
  ...
  biome: 'Border Forest',
  enemyPool: ['mist_ninja', 'trap_master', 'missing_nin', 'hired_assassin', 'camp_raider', 'forest_bandit'],
  lootTable: 'rogue_wilderness',
...
const WATERFALL_PASS: LocationConfig = {
  ...
  enemyPool: ['assassin', 'hired_assassin', 'missing_nin', 'mist_ninja', 'hidden_guard', 'water_spirit'],
...
const SOUND_FOUR_CAMP: LocationConfig = {
  ...
  biome: 'Oto Camp',
  enemyPool: ['elite_mercenary', 'bandit_captain', 'hired_muscle', 'war_dog', 'assassin', 'elite_guard'],
...
const CURSE_MARK_SHRINE: LocationConfig = {
  ...
  biome: 'Cursed Shrine',
  enemyPool: ['cursed_servant', 'corrupted_priest', 'elite_guard', 'shrine_demon', 'missing_nin', 'ronin'],
  lootTable: 'rogue_landmark',
...
const FOREST_OF_CHAINS: LocationConfig = {
  ...
  biome: 'Wire Forest',
  enemyPool: ['trap_master', 'hired_assassin', 'mist_ninja', 'camp_raider', 'forest_bandit', 'assassin'],
  lootTable: 'rogue_wilderness',
...
const NORTHERN_HIDEOUT: LocationConfig = {
  ...
  enemyPool: ['elite_guard', 'mist_ninja', 'cursed_servant', 'elite_mercenary', 'shrine_demon', 'hidden_guard'],
  lootTable: 'rogue_stronghold',
...
const BRIDGE_TO_VALLEY: LocationConfig = {
  ...
  biome: 'Canyon Bridge',
  enemyPool: ['ronin', 'elite_guard', 'missing_nin', 'hired_assassin', 'elite_mercenary', 'assassin'],
  lootTable: 'rogue_landmark',
...
const VALLEY_OF_THE_END: LocationConfig = {
  ...
  enemyPool: ['elite_guard', 'assassin', 'ronin', 'elite_mercenary', 'cursed_servant', 'eldritch_guardian'],
...
const HIDDEN_SUPPLY_CACHE: LocationConfig = {
  ...
  biome: 'Reed Cache',
  enemyPool: ['camp_raider', 'smuggler', 'missing_nin', 'trap_master', 'forest_bandit', 'hired_muscle'],
...
const OROCHIMARU_LAB: LocationConfig = {
  ...
  biome: 'Forbidden Lab',
  enemyPool: ['cursed_servant', 'eldritch_guardian', 'shrine_demon', 'vengeful_ghost', 'missing_nin', 'corrupted_priest'],
  lootTable: 'rogue_secret',
...
const LIGHTNING_CLIFF: LocationConfig = {
  ...
  enemyPool: ['vengeful_ghost', 'missing_nin', 'ronin', 'assassin', 'elite_mercenary', 'eldritch_guardian'],
  lootTable: 'rogue_secret',
