...
const ALLIANCE_CAMP: LocationConfig = {
  ...
  terrainEffects: [],
  biome: 'War Camp',
  enemyPool: ['deserter', 'camp_raider', 'spy_infiltrator'],
...
const OUTER_TRENCHES: LocationConfig = {
  ...
  biome: 'Trench Line',
  enemyPool: ['white_zetsu', 'reanimated_chunin', 'trench_raider'],
...
const SCAVENGER_FIELD: LocationConfig = {
  ...
  enemyPool: ['scavenger', 'reanimated_shinobi', 'zetsu_mimic'],
  lootTable: 'war_wilderness',
...
const ASH_FOREST: LocationConfig = {
  ...
  biome: 'Ash Forest',
  enemyPool: ['fire_zetsu', 'reanimated_jonin', 'ash_spirit'],
  lootTable: 'war_wilderness',
...
const VILLAGE_RUINS: LocationConfig = {
  ...
  enemyPool: ['reanimated_villager', 'masked_envoy', 'zetsu_infiltrator'],
  lootTable: 'war_settlement',
...
const ARTILLERY_RIDGE: LocationConfig = {
  ...
  biome: 'Gun Ridge',
  enemyPool: ['ridge_gunner', 'reanimated_elite', 'saboteur'],
...
const ALLIANCE_HQ: LocationConfig = {
  ...
  biome: 'Command Post',
  enemyPool: ['hq_assassin', 'reanimated_kage_guard', 'infiltrator_elite'],
...
const GOD_TREE_ROOTS: LocationConfig = {
  ...
  biome: 'Divine Roots',
  enemyPool: ['root_zetsu', 'chakra_leech', 'reanimated_sannin'],
  lootTable: 'war_wilderness',
...
const REANIMATION_NEXUS: LocationConfig = {
  ...
  biome: 'Coffin Field',
  enemyPool: ['edo_anchor', 'reanimated_boss_guard', 'mask_cultist'],
  lootTable: 'war_stronghold',
...
const GOD_TREE_HEART: LocationConfig = {
  ...
  biome: 'God Tree Core',
  enemyPool: ['ten_tails_spawn', 'madara_echo', 'obito_masked', 'ten_tails_madara'],
  lootTable: 'war_boss',
...
const SEALED_BUNKER: LocationConfig = {
  ...
  biome: 'War Bunker',
  enemyPool: ['bunker_zetsu', 'reanimated_scout'],
...
const BIJUU_CHAKRA_POOL: LocationConfig = {
  ...
  biome: 'Bijuu Spring',
  enemyPool: ['chakra_wraith', 'jinchuriki_echo'],
  lootTable: 'war_secret',
...
const TEN_TAILS_FRAGMENT: LocationConfig = {
  ...
  biome: 'Fragment Seal',
  enemyPool: ['fragment_spawn', 'madara_shadow', 'truth_seeker_orb'],
  lootTable: 'war_secret',
